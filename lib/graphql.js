...
/**
 * Header-image sizing was added after the original article query. Keep it
 * isolated so an older WPGraphQL schema cannot reject the entire article
 * operation during a staggered CMS/application rollout.
 */
