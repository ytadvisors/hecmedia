 ...
 *
 * - trendingSettings.maxVideos — Max videos to show (Trending Now)
 * - forEducators — logo, link, label for the rail card
 * - trendingPosts — server-side list already capped by maxVideos
 */
 ...
 * optional trendingPostIds). Kept as a fallback when GET_HEC_SITE_SETTINGS
