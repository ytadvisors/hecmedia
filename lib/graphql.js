...
export const GET_CATEGORY_NAV_NODE = gql`
  query CategoryNavNode($id: ID!) {
...
export const GET_CATEGORY_NAV_CHILDREN = gql`
  query CategoryNavChildren($parent: Int!) {
    categories(first: 100, where: { parent: $parent }) {
      nodes {
        link
        name
      }
