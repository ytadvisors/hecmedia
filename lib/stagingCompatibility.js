...
export const mergeHecSiteChrome = (siteSettings, legacySiteContent) => {
  ...
  const { mobileDisplay } = trendingSettings;
  let { mobileRailFirst } = legacy;
  if (mobileDisplay === "menu-content") mobileRailFirst = true;
  if (mobileDisplay === "content-menu") mobileRailFirst = false;
