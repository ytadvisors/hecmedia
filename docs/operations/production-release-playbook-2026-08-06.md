...
| 2026-08-07T01:53Z | Process policy on master | hecmedia **#260 MERGED** (`1fba22a`) — co-sign + §18 log + commander right hand = **one rep per unflagged provider** is now required process |
