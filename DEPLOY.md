...
> **NEXT 16 / REACT 18 CHECKPOINT — DO NOT DEPLOY**
>
> The `upgrade/next16` compatibility checkpoint upgrades the application runtime to
> Next.js 16 on React 18, but this repository still packages Lambda@Edge
> with the Next-9-era
...
> Deployment remains blocked until the `@sls-next/*` stack is upgraded for Next 16
